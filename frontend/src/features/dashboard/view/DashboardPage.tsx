  ...
  const outboundMetrics: DashboardQueueMetric[] = [
    {
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderStage: "IN_PROCESS" }) : undefined,
    },
    {
      key: "outbound-move",
      label: "To Move",
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderStage: "TO_MOVE" }) : undefined,
    },
    {
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderException: "ABNORMAL_PACKAGE" }) : undefined,
    },
    {
      key: "outbound-pick",
      label: "To Pick",
      ...
      to: canViewOps ? buildDashboardLink("/outbound/workbench", { pickTaskStatuses: "OPEN,ASSIGNED" }, "secondary-picking") : undefined,
    },
    {
      key: "outbound-print",
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderStage: "TO_SHIP", waybillPrinted: "false" }) : undefined,
    },
    {
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderException: "ORDER_INTERCEPTION" }) : undefined,
    },
    {
      key: "outbound-ship",
      label: "To Ship",
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderStage: "TO_SHIP", waybillPrinted: "true" }) : undefined,
    },
    {
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderStage: "GET_TRACKING_NO" }) : undefined,
    },
  ];
  ...
  const dispatchMetrics: DashboardQueueMetric[] = [
    {
      ...
      to: canViewOps ? buildDashboardLink("/outbound/workbench", { shipmentStatus: "POSTED" }, "shipping-manage") : undefined,
    },
    {
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderStatuses: "OPEN,ALLOCATED,PICKING,PICKED" }) : undefined,
    },
    {
      ...
      to: canViewOps ? buildDashboardLink("/outbound", { salesOrderStatus: "CANCELLED" }) : undefined,
    },
  ];
