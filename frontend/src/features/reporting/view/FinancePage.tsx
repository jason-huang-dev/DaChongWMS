...
export function FinancePage() {
  ...
  const {
    ...
    initialInvoiceFilters: {
      invoice_number__icontains: searchParams.get("invoiceNumber") ?? "",
      status: searchParams.get("invoiceStatus") ?? "",
      "finance_approval__status": searchParams.get("financeApprovalStatus") ?? "",
    },
    initialSettlementFilters: {
      status: searchParams.get("settlementStatus") ?? "",
    },
    initialDisputeFilters: {
      status: searchParams.get("disputeStatus") ?? "",
      status__in: searchParams.get("disputeStatuses") ?? "",
      reason_code: searchParams.get("disputeReason") ?? "",
    },
    initialExportFilters: {
      status: searchParams.get("financeExportStatus") ?? "",
    },
  });
