...
class ListModel(models.Model):
    ...
    goods_supplier = models.CharField(max_length=255, default="N/A", verbose_name="Goods Supplier")
    ...
    goods_unit = models.CharField(max_length=255, default="EA", verbose_name="Goods Unit")
    goods_class = models.CharField(max_length=255, default="Uncategorized", verbose_name="Goods Class")
    goods_brand = models.CharField(max_length=255, default="Generic", verbose_name="Goods Brand")
    goods_color = models.CharField(max_length=255, default="N/A", verbose_name="Goods Color")
    goods_shape = models.CharField(max_length=255, default="N/A", verbose_name="Goods Shape")
    goods_specs = models.CharField(max_length=255, default="N/A", verbose_name="Goods Specs")
    goods_origin = models.CharField(max_length=255, default="N/A", verbose_name="Goods Origin")
