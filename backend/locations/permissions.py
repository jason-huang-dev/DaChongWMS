"""Permissions for location topology and lock endpoints."""
...
class CanManageLocationTopology(StaffRolePermission):
    allowed_roles = {"Manager", "Supervisor"}


class CanManageLocationLocks(StaffRolePermission):
