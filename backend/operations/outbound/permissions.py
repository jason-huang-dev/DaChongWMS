"""Permissions for outbound sales, picking, and shipment workflows."""
...
class CanManageOutboundRecords(BasePermission):
    allowed_roles: ClassVar[set[str]] = {"Manager", "Supervisor", "Outbound", "StockControl"}
