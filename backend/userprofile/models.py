"""Tenant-level user profile models.

Ported from the GreaterWMS project so header-token authentication and
multi-tenant validation have a backing data store.
"""
