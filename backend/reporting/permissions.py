"""Permissions for reporting and billing workflows."""
...
class CanManageReportingRecords(BasePermission):
...
class CanManageFinanceRecords(BasePermission):
    allowed_roles: ClassVar[set[str]] = {"Finance", "Manager", "Supervisor"}
