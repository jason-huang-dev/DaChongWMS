"""Permissions for handheld scanner workflows."""
...
class CanUseScannerWorkflow(BasePermission):
    allowed_roles: ClassVar[set[str]] = {"Inbound", "Outbound", "StockControl", "Manager", "Supervisor"}
